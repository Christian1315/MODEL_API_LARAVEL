...
<head>
    ...
    <title>LARAVEL MODEL API</title>
    <link rel="shortcut icon" href="my-logo.jpeg" type="image/x-icon">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="d-flex" role="search">
                                <img src="my-logo.jpeg" width="100px" class="shadow-lg p-3 bg-body rounded" alt="" srcset="">
                            </form>
                        </div>
                    </div>
                </nav>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-612 text-center">
                <h1 class="title">Model d'api de laravel</h1>
